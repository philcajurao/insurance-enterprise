...
/**
 * Title: Page Title
 * Slug: devotion/page-title
 * Categories: devotion, page-title
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/images/inner-banner.jpg'); ?>","id":6,"dimRatio":50,"overlayColor":"secondary","minHeight":300,"isDark":false} -->
...
<div class="wp-block-group alignwide"><!-- wp:post-title {"textAlign":"center","style":{"typography":{"textTransform":"uppercase","letterSpacing":"1px","fontSize":"42px","fontStyle":"normal","fontWeight":"700"}},"textColor":"white"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->